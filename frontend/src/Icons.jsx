...
export const Sparkline = ({ type = "line" }) => {
    const path = type === "up"
        ? "M1 10 L5 8 L10 12 L15 5 L20 8 L25 2"
        : type === "stable"
            ? "M1 8 L5 8 L10 7 L15 8 L20 8 L25 8"
            : "M1 5 L5 8 L10 4 L15 9 L20 6 L25 9";

    return (
        <svg width="40" height="20" viewBox="0 0 26 14" fill="none" stroke="currentColor" className="sparkline">
