                          ...
                          return (
                            <div key={item.label} className="space-y-1">
                              <div className="flex items-center justify-between text-sm font-medium">
                                ...
                                <span className={isActive ? 'text-dark font-semibold' : 'text-slate-700 font-normal'}>{item.value.toFixed(1)}%</span>
                              </div>
                              <div className="h-2 w-full rounded-full bg-slate-100 overflow-hidden border border-slate-200/30">
                                <div
                                  className={cn(
                                    ...
                                    isActive
                                      ? `bg-gradient-to-r ${getGradeGradient(calculatedConsensusGrade)} shadow-sm`
                                      : 'bg-slate-300'
                                  )}
